...
void saveResultToFile_fixed(const char* filename, float arr[], int count);
int isSorted(float arr[], int count);
void merge(float arr[], int left, int mid, int right);
void mergeSortSerial(float arr[], int left, int right);
void mergeSortParallel(float arr[], int left, int right);
